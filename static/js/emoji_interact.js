document.addEventListener('DOMContentLoaded', function() {
    ...
    const contentTextarea = document.getElementById('comment');
    const contentEditor = document.querySelector('.content-editor');

    // 2. 检查这些元素是否存在
    if (!emojiButton || !emojiPopup || !contentTextarea || !contentEditor) {
